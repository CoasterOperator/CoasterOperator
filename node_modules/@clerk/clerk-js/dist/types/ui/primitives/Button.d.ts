...
} | undefined) => (theme: import("../styledSystem").InternalTheme<Readonly<{
...
declare const SimpleButton: React.ForwardRefExoticComponent<Omit<ButtonProps, "ref"> & React.RefAttributes<HTMLButtonElement>>;
